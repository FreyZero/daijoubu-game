  ...
  <div class="card upload-card">
    <div class="grid">
      <div class="field">
        ...
        <input id="cols" v-model.number="inputCols" type="number" inputmode="numeric" min="1" max="50" class="input">
      </div>
      <div class="field">
        <label class="label" for="rows">Rows</label>
        <input id="rows" v-model.number="inputRows" type="number" inputmode="numeric" min="1" max="50" class="input">
      </div>
    ...
    <div class="dropzone" :class="{ 'is-dragover': isDragOver }" @dragenter.prevent="onDragEnter"
      @dragover.prevent="onDragOver" @dragleave.prevent="onDragLeave" @drop.prevent="onDrop">
      <label v-if="!previewUrl" class="drop-content" for="fileInput">
