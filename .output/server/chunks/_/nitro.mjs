...
const _eYR5qZrdxsoKFKbPh1R_IcYRlKuPHJ5t_kJanfr78Sc = (function(nitro) {
...
const plugins = [
  _eYR5qZrdxsoKFKbPh1R_IcYRlKuPHJ5t_kJanfr78Sc
];
...
const assets = {
  "/favicon.ico": {
    ...
    "mtime": "2025-08-09T06:54:30.908Z",
    "size": 4286,
...
const _aETaBm = eventHandler((event) => {
...
const _90zIOa = defineCachedEventHandler(async (event) => {
...
const _lazy_VniFGw = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _aETaBm, lazy: false, middleware: true, method: undefined },
