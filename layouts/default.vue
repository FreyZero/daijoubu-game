...
.brand { display: inline-flex; align-items: center; gap: 0.6rem; color: #fff; text-decoration: none; font-weight: 800; }
.brand-logo { height: 40px; width: auto; display: block; }
.brand-text { letter-spacing: 0.3px; text-shadow: 0 1px 0 rgba(0,0,0,0.1); }
...
.site-nav a { color: #fff; text-decoration: none; font-weight: 600; padding: 0.5rem 0.25rem; border-radius: 8px; }
